...
func (q *Queries) CreateProduct(ctx context.Context, arg CreateProductParams) (int16, error) {
...
SELECT product_id, product_name, quantity_per_unit, unit_price, units_in_stock, units_in_order, reorder_level, discontinued, supplier_id, category_id FROM products
WHERE category_id = $1
`
